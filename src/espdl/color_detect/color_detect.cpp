#if __has_include(<opencv2/opencv.hpp>) || defined(ESP32P4_ESPDL_ENABLE_COLOR_DETECT)
...
#else
#warning "color_detect skipped (opencv-mobile not present). Define ESP32P4_ESPDL_ENABLE_COLOR_DETECT if you provide OpenCV."
#endif
